...
const RelatedDoctors = ({ speciality, doctorId }) => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            ...
            <p className='sm:w-1/3 text-center text-sm'>Dưới đây là danh sách các bác sĩ cùng chuyên khoa uy tín dành cho bạn</p>
            ...
            <button onClick={() => { navigate('/doctors'); window.scrollTo(0, 0) }} className='bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10'>Xem thêm</button>
        </div>
    )
}
