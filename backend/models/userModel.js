...
const userSchema = new mongoose.Schema({
    ...
    role: {
        type: String,
        enum: ["admin", "patient"], // 👈 Bỏ 'doctor' đi vì họ ở bảng riêng rồi
        default: "patient",
        required: false
    },
    address: {
        // Style của bạn bè (Đơn giản)
        line1: { type: String, default: "" },
        line2: { type: String, default: "" },

        // Style của bạn (Chi tiết hành chính)
        province: {
            code: { type: Number },
            name: { type: String }
        },
    ...
    resetPasswordExpire: { type: Number, default: null },
